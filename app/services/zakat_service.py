...
Функционал:
  ...
  - Расчёт для различных валют (UZS, USD, EUR, RUB) через курсы ЦБ РУз
...
def get_zakat_reminder(
    ...
    return {
        ...
        "recommendations": [
            ...
            "Сохраняйте квитанции о выплате закята",
        ],
    }
...
def get_zakat_guide() -> Dict[str, Any]:
    ...
    return {
        ...
        "sections": [
            ...
            {
                "title": "Налоговое законодательство Узбекистана",
                "content": (
                    "В настоящее время Налоговый кодекс Республики Узбекистан не предусматривает "
                    "специальных вычетов по НДФЛ для благотворительных пожертвований или закята. "
                    "Благотворительные взносы, как правило, не уменьшают налогооблагаемый доход. "

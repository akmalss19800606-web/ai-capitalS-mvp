...
from app.api.v1.routers import (
    ...
    islamic_compliance_router, islamic_contracts_router, islamic_education_router, islamic_indices_router,
)
...
api_router.include_router(islamic_indices_router.router)

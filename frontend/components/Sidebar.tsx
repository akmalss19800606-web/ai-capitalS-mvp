  ...
  },
  {
    ...
    items: [
      { labelKey: 'portfolios', path: '/portfolios',
        icon: <Icon paths={<><path d="M20 7h-4V5a2 2 0 0-2-2h-4a2 2 0 0-2 2v2H4a2 2 0 0-2 2v10a2 2 0 0 2 2h16a2 2 0 0 2-2V9a2 2 0 0-2-2z"/><path d="M10 5h4v2h-4z"/></>} /> },
      { labelKey: 'decisions', path: '/decisions',
        icon: <Icon paths={<><path d="M9 5H7a2 2 0 0-2 2v12a2 2 0 0 2 2h10a2 2 0 0 2-2h-2"/><path d="M9 5a2 2 0 0 2 2h2a2 2 0 0 2-2"/><path d="M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2"/><path d="M9 14h6"/><path d="M9 18h6"/></>} /> },

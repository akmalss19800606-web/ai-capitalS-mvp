...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Портфели', path: '/portfolios',
      ...
      { label: 'Согласование', path: '/workflows',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Импорт/Экспорт', path: '/data-exchange',
      ...
      { label: 'Адаптеры', path: '/market-adapters',
  ...
  },
  {
    title: 'Система',
    items: [
      { label: 'Совместная работа', path: '/collaboration',
...
/* ─── Exported arrays for Header breadcrumb ─── */
              ...
              return (
                <button key={item.path} onClick={() => navigate(item.path)}
                  ...
                  style={{
                    ...
                    margin: collapsed ? '2px 0' : '1px 8px',
                    borderRadius: collapsed ? '0' : '8px',
                    backgroundColor: isActive
                      ? (collapsed ? '#eff6ff' : '#eff6ff')
                      : 'transparent',
    ...
    <>
      ...
      >
        <div style={{ position: 'relative' }}>
          ...
          {/* Render full-width sidebar in mobile */}
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                  <div style={{ fontWeight: 700, fontSize: '14px', color: '#111827', lineHeight: 1.2 }}>AI Capital</div>
                  <div style={{ fontSize: '11px', color: '#9ca3af', marginTop: '1px' }}>Management</div>
                </div>
              </div>
            </div>
            ...
            <nav style={{ flex: 1, overflowY: 'auto', padding: '8px 0' }}>
              {NAV_GROUPS.map((group, gi) => (
                <div key={gi} style={{ marginBottom: '4px' }}>
                  <div style={{
                    padding: '8px 20px 4px', fontSize: '10px', fontWeight: 600,
                    color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.05em',
                  }}>
                    {group.title}
                  </div>
            ...
            <div style={{
              ...
              <span style={{ fontSize: '10px', color: '#9ca3af', fontWeight: 500 }}>v3.0 beta</span>
              <span style={{
                fontSize: '9px', padding: '1px 6px', borderRadius: '4px',
                backgroundColor: '#fef3c7', color: '#92400e', fontWeight: 600,
              }}>MVP</span>

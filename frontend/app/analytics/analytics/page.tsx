...
function AiAnalysisBlock() {
  ...
  const statusStyle: Record<string, { bg: string; badge: string; icon: string }> = {
  ...
  const statusLabel: Record<string, string> = { ok: 'OK', warn: '\u0412\u041D\u0418\u041C\u0410\u041D\u0418\u0415', bad: '\u041A\u0420\u0418\u0422\u0418\u0427\u041D\u041E' };
  const statusIcon: Record<string, string> = { ok: '\u2705', warn: '\u26a0\ufe0f', bad: '\u274c' };
